...
const Event = ({ uniqueName, eventName, eventDescription, image }) => {
  ...
  return (
    <div
      ...
      } lg:w-full w-5/6 border-2 border-black rounded-md p-7 flex flex-col gap-9 items-center cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-90 aspect-[1/1] text-center`}
    >
