...
const Flagship = ({ uniqueName, eventName, eventDescription, image }) => {
  ...
  return (
    <div
      className={`p-9 md:w-1/2 border-2 border-black rounded-md  flex flex-col gap-9 items-center cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-90 aspect-[1/1] text-center`}
    >
